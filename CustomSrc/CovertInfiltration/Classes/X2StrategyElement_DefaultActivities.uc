...
static function InformantAssaultOnPreMission (XComGameState StartGameState, XComGameState_Activity ActivityState)
{
	...
	`log("InformantAssaultOnPreMission");
	...
	`log("Created FriendlyVIPCivilian as first BattleData.RewardUnits:" @ VipUnitState.ObjectID @ VipUnitState.GetFullName());
