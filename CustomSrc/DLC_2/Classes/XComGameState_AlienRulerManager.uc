...
//---------------------------------------------------------------------------------------
function AddRulerAdditionalTacticalTags(XComGameState_HeadquartersXCom XComHQ, int NumAppearances, AlienRulerData RulerData)
{
...
//---------------------------------------------------------------------------------------
function int GetRulerAppearChance(XComGameState_Unit UnitState)
{
...
function bool ChosenOnMission(XComGameState_MissionSite MissionState)
{
...
function RemoveChosenFromMission(XComGameState NewGameState, XComGameState_MissionSite MissionState, XComGameState_HeadquartersXCom XComHQ)
{
...
//---------------------------------------------------------------------------------------
function bool MissionSitrepsBanRulers(XComGameState_MissionSite MissionState)
{
...
//---------------------------------------------------------------------------------------
function bool CanRulerAppearOnMission(XComGameState_MissionSite MissionState)
{
...
function UpdateActiveAlienRulers()
{
	local XComGameStateHistory History;
...
//---------------------------------------------------------------------------------------
function bool CanRulerBeActivated(int RulerIndex, StateObjectReference RulerRef, int ForceLevel)
{
...
//---------------------------------------------------------------------------------------
function SetRulerOnCurrentMission(XComGameState NewGameState, XComGameState_Unit UnitState, XComGameState_HeadquartersXCom XComHQ)
{
...
//---------------------------------------------------------------------------------------
function bool AreAlienRulersAllowedToSpawn()
{
	local XComGameStateHistory History;
...
//---------------------------------------------------------------------------------------
function StateObjectReference GetRulerLocatedAtMission(XComGameState_MissionSite MissionState)
{
